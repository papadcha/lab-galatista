...
- **Αλλαγή ημερομηνίας έναρξης υποπεριόδου CE** — αν μπει λάθος ημερομηνία δεν διορθώνεται. Δείγματα πριν την έναρξη δεν εντάσσονται στην περιοδική αναφορά.
...
- **Sync & backup βιβλιοθήκης εγγράφων** — μαζικό sync ολόκληρης της βιβλιοθήκης ([#4](https://github.com/papadcha/lab-galatista/issues/4)).
- **Frameless window** — αφαίρεση native Windows title bar ([#5](https://github.com/papadcha/lab-galatista/issues/5)).
...
- **Επιβεβαίωση toast φακέλου δεδομένων** — να επιβεβαιωθεί στην πράξη ότι λύνει το πρόβλημα "δεν βλέπω PDF" στο μηχάνημα του χειριστή.
