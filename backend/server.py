...
from database.db_manager import (
    ...
    set_document_quick_access,
    get_quick_access_ce_certificate,
    get_quick_access_official_tests_products,
    get_quick_access_official_tests_doc,
    get_quick_access_dop_standards,
    get_quick_access_dop_products,
    get_quick_access_dop_files,
    get_quick_access_standard_groups,
    get_quick_access_standards,
    get_samples_count,
    get_init_status,
    update_subperiod,
...
RENDERER_METHODS = frozenset({
    ...
    'get_quick_access_ce_certificate', 'get_quick_access_dop_files',
    'get_quick_access_dop_products', 'get_quick_access_dop_standards',
    'get_quick_access_official_tests_doc', 'get_quick_access_official_tests_products',
    'get_quick_access_standard_groups', 'get_quick_access_standards',
...
METHODS = {
    ...
    'set_document_quick_access': lambda args: set_document_quick_access(
                                     int(args[0]),
                                     args[1] if len(args)>1 else None,
                                     args[2] if len(args)>2 else None,
                                     args[3] if len(args)>3 else None,
                                     args[4] if len(args)>4 else None),
    'get_quick_access_ce_certificate':            lambda args: get_quick_access_ce_certificate(),
    'get_quick_access_official_tests_products':   lambda args: get_quick_access_official_tests_products(),
    'get_quick_access_official_tests_doc':        lambda args: get_quick_access_official_tests_doc(int(args[0])),
    'get_quick_access_dop_standards':             lambda args: get_quick_access_dop_standards(),
    'get_quick_access_dop_products':               lambda args: get_quick_access_dop_products(args[0]),
    'get_quick_access_dop_files':                  lambda args: get_quick_access_dop_files(args[0], int(args[1])),
    'get_quick_access_standard_groups':            lambda args: get_quick_access_standard_groups(),
    'get_quick_access_standards':                  lambda args: get_quick_access_standards(args[0]),
