...
def clean_start(vacuum_dest_path: str) -> dict:
    """
    Clean Start — κλείσιμο τρέχουσας CE period:
    1. VACUUM INTO για final backup (πριν κληθεί αυτή η function)
    2. Διαγραφή όλων των δειγμάτων και εξαρτημένων δοκιμών
    3. Reset sample_counter στο tbl_laboratory
